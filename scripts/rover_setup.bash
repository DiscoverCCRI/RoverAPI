...
cd /home/pi && git clone https://github.com/DiscoverCCRI/RoverAPI \
    ...
    && echo "/opt/ros/noetic/setup.bash" >> /home/pi/.bashrc \
    && echo "/home/pi/catkin_ws/devel/setup.bash" >> /home/pi/.bashrc \
    && mv /home/pi/RoverAPI/scripts/example.py /home/pi \
    && chmod u+x /home/pi/example.py \
    && sudo rm -r /home/pi/RoverAPI
sudo apt-get install cron
crontab -l | { cat; echo "@reboot sleep 20; sudo date -s \"$(wget -qSO- --max-redirect=0 google.com 2>&1 | grep Date: | cut -d' ' -f5-8)Z\""; } | crontab -
